...
public class FabFormaticWebService implements FABws {
	...
	public IncidentInputOutput incidentInput(String accountID,
		...
		IncidentInputOutput iio = assuranceService.incidentInput(accountID, contactPerson, incidentDesc, serviceID, sessionID, transID);
	...
	public IncidentTrackingOutput incidentTracking(String accountID,
		...
		IncidentTrackingOutput ito = assuranceService.incidentTracking(accountID, serviceID, sessionID);
