 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://fab/}getBillingDataOutput" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetBillingDataResponse {
    ...
    protected List<GetBillingDataOutput> _return;
     ...
     * 
     */
    public List<GetBillingDataOutput> getReturn() {
        if (_return == null) {
            _return = new ArrayList<GetBillingDataOutput>();
        }
        return this._return;
    }
