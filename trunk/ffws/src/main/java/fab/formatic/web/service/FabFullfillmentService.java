...
public interface FabFullfillmentService {
	...
	OrderInputOutput orderInput(String accountID, Module module, Package paket,
			List<ServiceAttr> serviceAttrs, String serviceID, String sessionID,
			String transType, String transID);

	List<Trans> orderTracking(String accountID, String serviceID, String sessionID,
			String transID);
