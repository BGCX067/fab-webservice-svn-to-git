 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://fab/}incidentTrackingOutput" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class IncidentTrackingResponse {
    ...
    protected List<IncidentTrackingOutput> _return;
     ...
     * 
     */
    public List<IncidentTrackingOutput> getReturn() {
        if (_return == null) {
            _return = new ArrayList<IncidentTrackingOutput>();
        }
        return this._return;
    }
